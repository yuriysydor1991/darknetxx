...
class DefaultLogger
{
 public:
  ...
  /**
   * @brief Formats a printf-style message into a std::string. Used by the
   * FMTLOGI macro and the C logging bridge (cpplog4c) to forward the original
   * Darknet printf-style log calls.
   */
