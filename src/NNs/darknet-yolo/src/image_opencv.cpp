                               ...
                               int *boxonly, int classes, char **names)
{
  ...
  int it_tb_res = cv::createTrackbar(it_trackbar_name, window_name,
                                     &it_trackbar_value, 1000);
  ...
  int cl_tb_res = cv::createTrackbar(cl_trackbar_name, window_name,
                                     &cl_trackbar_value, classes - 1);
