                            ...
                            bool last_connection)
{
  ...
  if (req.method == "POST" || req.method == "PUT" || req.method == "PATCH") {
    ...
    if (req.method == "POST") {
      ...
      if (dispatch_request_for_content_reader(
              req, res, content_reader, put_handlers_for_content_reader)) {
        return true;
      }
...
inline std::shared_ptr<Response> Client::Post(
    const char *path, const Headers &headers, size_t content_length,
    ContentProvider content_provider, const char *content_type, bool compress)
{
...
inline std::shared_ptr<Response> Client::Post(
    const char *path, const MultipartFormDataItems &items, bool compress)
{
