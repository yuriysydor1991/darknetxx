                  ...
                  int ksize, int stride, int pad, float* data_im)
{
  ...
  col2im_gpu_kernel<<<(num_kernels + BLOCK - 1) / BLOCK, BLOCK, 0,
                      get_cuda_stream()>>>(num_kernels, data_col, height, width,
...
__global__ void col2im_gpu_kernel_ext(
    const int n, const float* data_col, const int height, const int width,
...
void col2im_gpu_ext(const float* data_col, const int channels, const int height,
