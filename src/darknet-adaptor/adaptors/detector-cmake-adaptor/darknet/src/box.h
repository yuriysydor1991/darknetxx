...
void do_nms_sort_v2(box *boxes, float **probs, int total, int classes,
                    float thresh);
// LIB_API void do_nms_sort(detection *dets, int total, int classes, float
// thresh); LIB_API void do_nms_obj(detection *dets, int total, int classes,
// float thresh); LIB_API void diounms_sort(detection *dets, int total, int
// classes, float thresh, NMS_KIND nms_kind, float beta1);
