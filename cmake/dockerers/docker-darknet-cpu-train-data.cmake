...
set(
  DARKNET_CPU_TRAIN_DOCKERFILE_DST
  "${CMAKE_BINARY_DIR}/Dockerfile.Darknet-CPU"
)
...
configure_file(${DARKNET_CPU_TRAIN_DOCKERFILE_SRC} ${DARKNET_CPU_TRAIN_DOCKERFILE_DST})

set(
  DARKNET_CPU_TRAIN_DOCKER_SINGLE_RUN_NAME
...
# --no-cache
set(
  DARKNET_CPU_TRAIN_DOCKER_SINGLE_BUILD_CMD
    DOCKER_HOST=${DOCKER_HOST_STR} DOCKER_BUILDKIT=1 ${DOCKER_EXEC} build
      -f "${DARKNET_CPU_TRAIN_DOCKERFILE_DST}"
      ...
      -t ${DARKNET_CPU_TRAIN_DOCKER_SINGLE_RUN_NAME} .
)
...
set(
  DARKNET_CPU_TRAIN_DOCKER_SINGLE_RUN_CMD
    xhost +local:docker &&
...
add_custom_target(
  docker-single-build-darknet-cpu-train
  COMMAND ${DARKNET_CPU_TRAIN_DOCKER_SINGLE_BUILD_CMD}
  COMMENT "Building the docker single run image ${DARKNET_CPU_TRAIN_DOCKER_SINGLE_RUN_NAME}"
  WORKING_DIRECTORY ${CMAKE_SOURCE_DIR}
)

add_custom_target(
  docker-single-run-darknet-cpu-train
  COMMAND ${DARKNET_CPU_TRAIN_DOCKER_SINGLE_RUN_CMD}
  DEPENDS docker-single-build-darknet-cpu-train
