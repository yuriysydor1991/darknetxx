...
Дивись секцію [Доступні параметри командного рядка](#доступні-параметри-командного-рядка) для повного переліку параметрів, які вже підтримує реалізація за замовчуванням.
...
Для впровадження власного нового параметра командного рядка дивись секцію [Впровадження нових параметрів командного рядка](#впровадження-нових-параметрів-командного-рядка).
